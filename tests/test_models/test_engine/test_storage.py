...
class TestFileStorage_instantiation(unittest.TestCase):
    """Unittests for instanting FileStorage class."""

    def test_FileStorage_instantiating_no_args(self):
        self.assertEqual(type(FileStorage()), FileStorage)

    def test_FileStorage_instantiating_with_arg(self):
        with self.assertRaises(TypeError):
            FileStorage(None)

    def test_FileStorage_file_private_path(self):
...
class TestFileStorage_methods(unittest.TestCase):
    """Unittests for methods of FileStorage."""
