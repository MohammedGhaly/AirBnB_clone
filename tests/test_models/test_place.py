...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_city_i_public_class_attribute(self):
        pl = Place()
    ...
    def test_instantiation_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        pl = Place(id="3453", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(pl.id, "3453")
